...
export default function DraggablePreview({ selectedImages, onReorder, onRemove, isProcessing = false }: DraggablePreviewProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h3 className="text-xl font-semibold mb-4 text-gray-800">
        Selected Images Preview (drag to reorder)
        {isProcessing && (
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        {selectedImages.map((selectedImage) => (
          <div
            ...
            className={`relative group cursor-move bg-white rounded-lg border-2 transition-all duration-200 hover:shadow-lg hover:scale-105 ${
